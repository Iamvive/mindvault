...
## Corpus Check
- 124 files · ~94,785 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1095 nodes · 1274 edges · 96 communities (80 shown, 16 thin omitted)
...
- `performSync()` --calls--> `saveDailyScore()`  [EXTRACTED]
  sanjaya/src/server.js → sanjaya/src/database.js
...
Cohesion: 0.07
Nodes (29): any, BaseModel, @google/genai, dependencies, dotenv, express, @google/genai, react (+21 more)
...
Cohesion: 0.17
Nodes (10): plugins, rules, react/only-export-components, react/rules-of-hooks, $schema, App(), oxc, react (+2 more)
...
Cohesion: 0.19
Nodes (13): DB_DIR, fs, getDailyScores(), getDbConnection(), path, runMigrations(), saveDailyScore(), sqlite3 (+5 more)

### Community 82 - "shravana.test.js"
Cohesion: 0.14
Nodes (12): performSync(), runBackgroundAutoSync(), backupToVault(), fetchDailyTranscripts(), fs, path, { spawn }, assert (+4 more)
...
Cohesion: 0.15
Nodes (12): analyzeTranscript(), { GoogleGenAI }, { analyzeTranscript }, app, express, { fetchDailyTranscripts, backupToVault }, fs, { getDailyScores, saveDailyScore } (+4 more)
...
### Community 92 - "anthropic-best-practices.md"
Cohesion: 0.40
Nodes (4): [Analysis Title], Executive summary, Key findings, Recommendations

### Community 94 - "Checklist for effective Skills"
Cohesion: 0.50
...
## Knowledge Gaps
- **621 isolated node(s):** `crypto`, `http`, `fs`, `path`, `OPCODES` (+616 more)
